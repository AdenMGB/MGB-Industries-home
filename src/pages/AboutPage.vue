...
<template>
  <div class="min-h-screen py-24 px-4 md:px-8">
    <div class="max-w-6xl mx-auto">
      ...
      <!-- Bio Section (Admin-style card with pastel accents) -->
      <div
        class="bio-section mb-20 p-8 md:p-12 rounded-2xl bg-white/40 dark:bg-gray-800/80 backdrop-blur-md border border-gray-200/50 dark:border-gray-700/50"
      >
        <div class="grid md:grid-cols-12 gap-12 items-start">
          ...
          <div class="md:col-span-5">
            <div class="p-8 rounded-2xl bg-peach/5 dark:bg-peach/10 backdrop-blur-md border border-peach/20 dark:border-peach/20 shadow-sm">
              <div class="space-y-6">
                <div class="flex items-start gap-4 group cursor-default">
                  <div class="p-3 rounded-xl bg-peach/10 dark:bg-peach/20 group-hover:bg-peach/20 dark:group-hover:bg-peach/30 transition-all duration-300 group-hover:scale-105">
                    <MapPinIcon class="w-5 h-5 text-peach" />
                  </div>
                  <div class="flex-1">
                    <div class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1.5">Location</div>
                    <div class="text-lg font-semibold text-gray-800 dark:text-white">Adelaide, Australia</div>
                  </div>
                </div>
                <div class="flex items-start gap-4 group cursor-default">
                  <div class="p-3 rounded-xl bg-lavender/10 dark:bg-lavender/20 group-hover:bg-lavender/20 dark:group-hover:bg-lavender/30 transition-all duration-300 group-hover:scale-105">
                    <CodeBracketIcon class="w-5 h-5 text-lavender" />
                  </div>
                  <div class="flex-1">
                    <div class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1.5">Role</div>
                    <div class="text-lg font-semibold text-gray-800 dark:text-white">Full Stack Developer</div>
                  </div>
                </div>
                <div class="flex items-start gap-4 group cursor-default">
                  <div class="p-3 rounded-xl bg-mint/10 dark:bg-mint/20 group-hover:bg-mint/20 dark:group-hover:bg-mint/30 transition-all duration-300 group-hover:scale-105">
                    <RocketLaunchIcon class="w-5 h-5 text-mint" />
                  </div>
                  <div class="flex-1">
                    <div class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1.5">Status</div>
                    <div class="text-lg font-semibold text-gray-800 dark:text-white">Open Source Contributor</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <!-- Timeline (Admin-style section header) -->
      <div class="mb-20">
          ...
          <div class="space-y-8">
            ...
            >
              ...
              <div
                ...
                class="absolute left-5 top-8 bottom-0 w-0.5 bg-peach/20 dark:bg-peach/40"
              />
              
              <!-- Timeline dot -->
              <div
                class="absolute left-0 top-1 w-3 h-3 rounded-full bg-peach border-2 border-white dark:border-gray-800 shadow-sm"
              />
              ...
              <div
                :class="cn(
                  ...
                  'bg-white/40 dark:bg-gray-800/80 backdrop-blur-sm',
